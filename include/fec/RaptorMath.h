...
/// RFC 5053 §5.4.2.3 Half symbols: "Let ... a sequence of Gray sequences of
/// length K+S, each with exactly Hprime ones in binary representation". Walks
/// integers in order, keeping every Gray-coded value (x ^ (x>>1)) that has
/// exactly `ones` bits set, until `length` of them have been collected.
