...
/// RFC 6330 Section 5.3.3.3, first loop + LDPC-relation identity part:
/// for each of the B "LT-only" intermediate symbols (columns [0, B)),
/// which of the S LDPC rows it XORs into. Coefficients are all 1 -- the
