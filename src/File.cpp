...
{
/* Both divisors come from the FEC OTI and both are used as denominators below, in this
     function's RFC 5052 path and in calculate_partitioning_raptor()'s Kt alike. A
     ...
     Checked before the Raptor dispatch, not after, because that path divides by
     encoding_symbol_length as well. */
